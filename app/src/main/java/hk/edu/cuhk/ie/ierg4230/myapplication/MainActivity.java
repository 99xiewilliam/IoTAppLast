...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text.setText(AvgHeartbeat);
        snakeView.setMinValue(0);
        snakeView.setMaxValue(200);
        snakeView.addValue(Integer.parseInt(AvgHeartbeat));
//        textView = (TextView) findViewById(R.id.textView);
//        textView2 = (TextView) findViewById(R.id.textView2);
//
//        textView.setText("instantHeartbeat: " + "0");
//        textView2.setText("AvgHeartbeat: " + "0");
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                Runnable runnable = () -> {
                    fetchData();
//                    textView.setText("instantHeartbeat: " + instantHeartbeat);
//                    textView2.setText("AvgHeartbeat: " + AvgHeartbeat);
                    text.setText(AvgHeartbeat);
                    snakeView.addValue(Integer.parseInt(AvgHeartbeat));
                    ...
                    }else if (Double.parseDouble(AvgHeartbeat) < 40) {
